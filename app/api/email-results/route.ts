...
<html lang="en">
<head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Runback Results</title></head>
  ...
  <tr><td align="center">
    <table width="100%" cellpadding="0" cellspacing="0" style="max-width:600px;">
      ...
      <tr><td style="background:linear-gradient(135deg,#4338ca,#6366f1);border-radius:16px 16px 0 0;padding:32px 32px 28px;text-align:center;">
        ...
        <h1 style="margin:0 0 4px;color:#fff;font-size:22px;font-weight:700;">Runback Results</h1>
      ...
      <tr><td style="background:#111827;padding:24px 32px 0;border-left:1px solid #1f2937;border-right:1px solid #1f2937;">
        <p style="margin:0;color:#e5e7eb;font-size:15px;line-height:1.6;">${greeting} Here are your Runback results. Keep the feedback below in mind for your next practice session.</p>
      </td></tr>
      ...
      <tr><td style="background:#111827;padding:0 32px 24px;border-left:1px solid #1f2937;border-right:1px solid #1f2937;">
        <div style="background:linear-gradient(135deg,#1e1b4b,#1a1040);border:1px solid #4338ca55;border-radius:12px;padding:24px;text-align:center;">
          ...
          <p style="margin:0 0 20px;color:#9ca3af;font-size:13px;line-height:1.5;">Your feedback directly shapes how we improve Runback. It takes under a minute.</p>
      ...
      <tr><td style="background:#0a0a14;border:1px solid #1f2937;border-radius:0 0 16px 16px;padding:20px 32px;text-align:center;">
        <p style="margin:0 0 4px;color:#374151;font-size:12px;">Generated by <strong style="color:#6366f1;">Runback</strong></p>
    ...
    await transporter.sendMail({
      ...
      to,
      subject: `Your Runback Results — ${company} ${role}`,
      html,
    })
