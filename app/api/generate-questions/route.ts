...
export async function POST(req: NextRequest) {
  try {
    ...
    const verticalGuidance: Record<string, string> = {
      ...
      'Med School': 'Focus on clinical experience, empathy, resilience under pressure, and motivation for medicine. The role-specific question should explore clinical reasoning or a patient scenario. Avoid purely technical medical questions.',
      'PA School': 'Focus on patient interaction experience, motivation for PA over MD, clinical shadowing insights, and teamwork with physicians. The role-specific question should explore a clinical scenario or challenge.',
      'Law School': 'Focus on analytical reasoning, communication under pressure, ethical dilemmas, and academic preparation. The role-specific question should involve legal reasoning, a hypothetical scenario, or why this law school/area of law.',
      'MBA': 'Focus on post-MBA goals, leadership impact, collaborative decision-making, and why MBA now. The role-specific question should explore career vision, leadership philosophy, or a business case relevant to their target industry.',
