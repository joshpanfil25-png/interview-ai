              ...
              <div className={`flex items-center gap-2 px-3 py-1.5 rounded-xl border transition-colors duration-300 ${
                ...
                <svg
                  className={`w-3.5 h-3.5 shrink-0 transition-colors duration-300 ${
                    timerExpired || isWarning ? 'text-red-400' : 'text-gray-500'
                ...
                <span className={`text-sm font-mono font-semibold tabular-nums transition-colors duration-300 ${
                  timerExpired || isWarning ? 'text-red-400' : 'text-gray-300'
                }`}>
                  {timerDisplay}
                </span>
              </div>
            ...
            {timerExpired && (
              <div className="flex items-center gap-2.5 bg-red-500/10 border border-red-500/20 rounded-xl px-4 py-3">
                ...
                <p className="text-red-300 text-sm">
                  Time&apos;s up — wrap up your answer and move on when you&apos;re ready.
                </p>
              </div>
            )}
